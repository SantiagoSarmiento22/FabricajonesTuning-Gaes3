...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE epleado_proveedor SET nombre = '$nombre', direccion = '$direccion', correo = '$correo', telefono = '$telefono' WHERE id = '$id'";
...
if (isset($_GET["id"])) {
    ...
    $sql = "SELECT * FROM epleado_proveedor WHERE id = '$id'";
...
?>
        ...
        <body>
            <div class="container">
                ...
                <form action="editar_Empleado_Proveedor.php" method="POST">
