...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO proveedor (id, nombre, direccion,correo, telefono)
...
<body>
    ...
    <div class="formulario">
        ...
        <form action="proveedor.php" method="POST">
            ...
            <input type="text" id="Direccion" name="Direccion" pattern="[A-Za-z0-9\s]+" required><br>
                    ...
                    <tbody>
                        ...
                        if ($result !== false && $result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>";
                                echo "<a href='editar_Admin_Proveedor.php?id=" . $row["id"] . "' class='btn btn-small btn-warning'><i class='bx bx-edit'></i></a>";
                                echo "<a href='borrar_Admin_Proveedor.php?id=" . $row["id"] . "' class='btn btn-small btn-danger'><i class='bx bx-trash'></i></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        } else {
